...
@Component
@Slf4j
public class InvalidDeploymentUUIDAspect {

    /**
     * 捕获DeploymentUUID异常并且转换为恰当的http响应
     */
    @Around("execution(* com.autodl_backend.local.service.impl..*.*(..))")
    public Object HandleDeploymentUUIDException(ProceedingJoinPoint joinPoint) throws Throwable {
        try {
